---
title: The Complete Group Planning Guide
subtitle: How to coordinate 10-20+ people without losing your mind
category: Planning
---
...
1. **Collect deposits immediately** — Anyone who doesn't pay isn't really committed
2. **Use Splitwise from Day 1** — Add every expense, even small ones
3. **Settle up daily** — Don't let it pile up until the end
4. **Over-budget by 15%** — Surprises happen
...
> Estimated cost: $500-700 per person (not including flights)
>
...
>
> Your total: [Amount]
> (This covers: housing, activities, group dinners, bride's portion)
>
> Venmo: @[handle]
> Include: [Bride] Bach
>
...
>
> 📍 Itinerary + all details: [Google Doc Link]
> 📸 Photo album to upload to: [Link]
> 🎵 Playlist to add songs: [Spotify Link]
>
